namespace Common
{
        ...
        where T : BaseEntity
    {
        ...
        public async Task<IEnumerable<object>> SelectByExpressionAsync(Expression<Func<T, object>> expression)
        {
            return await _repsitory.SelectByExpressionAsync(expression);
        }
    }
}